/**
 * VerificaFisicaEquilibrio3F_FilaC – Verifica: Equilibrio del punto materiale
 * Liceo Linguistico 3F – Fisica – Maggio 2026 – FILA C
 */
...
export default function VerificaFisicaEquilibrio3F_FilaC(): React.ReactElement {
                ...
                <div style={S.sheet} className="verifica-sheet">
                    ...
                    <div style={S.headerDoc}>
                        ...
                        <div style={{ textAlign: "center" }}>
                            <span style={S.filaBadge}>FILA C</span>
                        </div>
                        <div style={S.metaRow}>
                    ...
                    <div style={S.parte}>
                        ...
                        {/* B.a — Prima legge di Newton / equilibrio dinamico */}
                        <div style={S.domanda}>
                        ...
                        {/* B.b — Forza vincolare: piano orizzontale con forza verso l'alto */}
                        <div style={S.domanda}>
                            ...
                            <p style={S.domandaText}>
                                ...
                                con una forza <L s="$F = 8{,}0\,\text{N}$" />. Qual è la forza vincolare esercitata
                                dal piano sul blocco?
                            </p>
                        ...
                        {/* B.c — Condizioni di equilibrio del corpo rigido */}
                        <div style={S.domanda}>
                        ...
                        <div style={S.domanda}>
                            ...
                            <p style={S.domandaText}>
                                ...
                                L'angolo di inclinazione soddisfa <L s="$\sin\theta = 0{,}80$" /> e{" "}
                        ...
                        <div style={S.domanda}>
                            ...
                            <div style={{ marginLeft: 16, marginTop: 10 }}>
                                ...
                                <p style={{ fontSize: 14, lineHeight: 1.7, color: "#1e293b", marginTop: 12, marginBottom: 6 }}>
                                    ...
                                    <L s="$\theta = 15°$" />. Sia la forza peso che la forza <L s="$F$" /> restano
                    ...
                    {showSoluzioni && (
                        <div style={S.soluzioniSection} className="soluzioni-section no-print">
                            <div style={S.soluzioniTitle}>✅ Soluzioni – Fila C</div>
                            ...
                            <div style={S.solParte}>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <p style={S.solText}>
                                        ...
                                        un'auto che avanza a velocità costante su strada piana).
                                    </p>
                                </div>
                            ...
                            <div style={S.solParte}>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <p style={S.solText}>
                                        Il moto rettilineo uniforme implica velocità costante, quindi accelerazione
                                        zero. Per la prima legge di Newton, la risultante delle forze deve essere
                                        zero: il corpo è in equilibrio dinamico. Non è necessario che non agiscano
                                        forze, ma che si bilancino.
                                    </p>
                                </div>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <div style={S.solStep}>
                                        ...
                                        <p style={{ fontSize: 13, marginTop: 4 }}>
                                            La risposta A (29,4 N) sarebbe corretta in assenza della corda.
                                            La risposta B (37,4 N) si otterrebbe sommando invece di sottrarre.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <p style={S.solText}>
                                        ...
                                        traslazionale (<L s="$\vec{F}_{\text{ris}} = \vec{0}$" />) ed equilibrio
                                        rotazionale (<L s="$\sum M = 0$" /> rispetto a qualsiasi punto). Un corpo
                                        rigido potrebbe ruotare anche se la risultante è zero, o accelerare il
                                        centro di massa anche se la somma dei momenti è zero.
                                    </p>
                                </div>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <div style={S.solStep}>
                                        ...
                                        <p style={{ fontSize: 13, marginTop: 4 }}>
                                            La risposta A (29,4 N) corrisponde a <L s="$mg \cdot 0{,}60 = mg\cos\theta$" />
                                            (componente perpendicolare). La risposta C (49,0 N) corrisponde al peso totale.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style={S.solParte}>
                                ...
                                {/* C.1 */}
                                <div style={S.solDomanda}>
                                    <span style={S.solLabel}>1) Piano orizzontale / inclinato — m = 4,0 kg, F = 8,0 N</span>
                                    ...
                                    <div style={S.solStep}>
                                        ...
                                        <DisplayMath>{"F_v = 4{,}0 \\times 9{,}8 + 8{,}0 = 39{,}2 + 8{,}0 = 47{,}2\\,\\text{N}"}</DisplayMath>
                                    </div>

                                    <p style={{ ...S.solText, fontWeight: 600, marginTop: 12, marginBottom: 4 }}>ii) Piano inclinato (θ = 15°): componenti di F_tot</p>
                                    <div style={S.solStep}>
                                        <p style={{ fontSize: 13 }}>
                                            La forza risultante verticale verso il basso è{" "}
                                            <L s="$F_{\text{tot}} = 47{,}2\,\text{N}$" />.
                                            Con <L s="$\sin 15° \approx 0{,}259$" /> e <L s="$\cos 15° \approx 0{,}966$" />:
                                        </p>
                                        <DisplayMath>{"F_{\\parallel} = F_{\\text{tot}}\\sin 15° = 47{,}2 \\times 0{,}259 \\approx 12{,}2\\,\\text{N}"}</DisplayMath>
                                        <DisplayMath>{"F_{\\perp} = F_{\\text{tot}}\\cos 15° = 47{,}2 \\times 0{,}966 \\approx 45{,}6\\,\\text{N}"}</DisplayMath>
                                    </div>
                                    ...
                                    <div style={S.solStep}>
                                        <p style={{ fontSize: 13 }}>
                                            ...
                                            <L s="$F_v = F_\perp \approx 45{,}6\,\text{N}$" />.
                                            La forza vincolare è diminuita rispetto al piano orizzontale (47,2 N)
                                            perché l'inclinazione riduce la componente perpendicolare della forza totale.
                                        </p>
                                    </div>
                                    ...
                                    <div style={S.solStep}>
                                        <p style={{ fontSize: 13 }}>
                                            Equilibrio lungo il piano: <L s="$F_{\text{att}} = F_\parallel \approx 12{,}2\,\text{N}$" />
                                        </p>
                                        ...
                                        <p style={{ fontSize: 13, marginTop: 4 }}>
                                            ...
                                            aggiuntiva <L s="$F$" />: essa modifica in egual misura sia il numeratore
                                            che il denominatore del rapporto.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div style={S.solDomanda}>
                                    ...
                                    <div style={S.solStep}>
                                        <p style={{ fontSize: 13 }}>
                                            Equilibrio lungo il piano: <L s="$F_{\text{att}} = F_\parallel = 23{,}5\,\text{N}$" />
                                        </p>
                                        <DisplayMath>{"\\mu_s = \\frac{F_{\\text{att}}}{F_v} = \\frac{23{,}5}{31{,}4} = 0{,}75"}</DisplayMath>
                                    </div>
                                    ...
                                    <div style={S.solStep}>
                                        ...
                                        <DisplayMath>{"F'_v = 4{,}0 \\times 9{,}8 \\times 0{,}60 = 23{,}5\\,\\text{N}"}</DisplayMath>
                                        <DisplayMath>{"F_{\\text{att,max}} = \\mu_s \\cdot F'_v = 0{,}75 \\times 23{,}5 = 17{,}6\\,\\text{N}"}</DisplayMath>
                                        <p style={{ fontSize: 13, marginTop: 6 }}>
                                            Poiché <L s="$F'_\parallel = 31{,}4\,\text{N} > F_{\text{att,max}} = 17{,}6\,\text{N}$" />,
